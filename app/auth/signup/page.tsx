      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-slate-100 dark:from-slate-900 dark:to-blue-950" dir={dir}>
        <div className="w-full max-w-md p-8">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-blue-600">{t.verifyTitle}</h1>
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            {error && (
              <div className="rounded-lg bg-red-50 p-3 text-sm text-red-600" dir="ltr">
                {error}
              </div>
            )}
      ...
      <div className="w-full max-w-md p-8">
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <p className="text-center text-sm">
            {t.hasAccount}{' '}
            <a href="/sign-in" className="font-semibold text-blue-600 hover:text-blue-700">
              {t.signin}
            </a>
          </p>
        </form>
