...
const ThreadScrollToBottom: FC = () => {
  ...
  return (
    <ThreadPrimitive.ScrollToBottom asChild>
      <TooltipIconButton
        tooltip={t('message.scrollToBottom')}
        variant="outline"
      ...
      <div className="aui-thread-welcome-center flex w-full flex-grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-8">
          ...
          <m.div
            ...
            className="aui-thread-welcome-message-motion-2 mt-2 text-xl text-muted-foreground/80"
          >
            {t('welcome.subtitle')}
          </m.div>
        </div>
...
const ThreadSuggestions: FC = () => {
  ...
  const suggestions = [
    {
      title: t('welcome.suggestion1.title'),
      label: t('welcome.suggestion1.label'),
      action: t('welcome.suggestion1.action'),
    },
    {
      title: t('welcome.suggestion2.title'),
      label: t('welcome.suggestion2.label'),
      action: t('welcome.suggestion2.action'),
    },
    {
      title: t('welcome.suggestion3.title'),
      label: t('welcome.suggestion3.label'),
      action: t('welcome.suggestion3.action'),
    },
    {
      title: t('welcome.suggestion4.title'),
      label: t('welcome.suggestion4.label'),
      action: t('welcome.suggestion4.action'),
    },
  ];
